...
<nav class="breadcrumbs" aria-label="Breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
  <ol>
    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
      <a itemprop="item" href="/"><span itemprop="name">হোম</span></a>
      <meta itemprop="position" content="1" />
    </li>
    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
      <span itemprop="name">সব পরীক্ষার ফলাফল</span>
...
<footer>
  <div class="footer-inner">
    <p class="warn">এটি একটি স্বাধীন, অনানুষ্ঠানিক ডিরেক্টরি। এটি শিক্ষা মন্ত্রণালয়, কোনো শিক্ষা বোর্ড, বাংলাদেশ সরকার বা কোনো প্রতিষ্ঠান দ্বারা পরিচালিত, অনুমোদিত বা সমর্থিত নয়।</p>
    ...
    <div class="footer-links" style="margin-top:8px;">
      ...
      <a href="#faq">প্রশ্ন ও উত্তর</a>
    </div>
    <p style="margin-top: 18px; font-size: 11px; opacity: 0.7;">&copy; <?php echo $currentYear; ?> <?php echo $siteName; ?>. সর্বস্বত্ব সংরক্ষিত।</p>
  </div>
</footer>
